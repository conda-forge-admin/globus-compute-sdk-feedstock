About globus-compute-sdk-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/globus-compute-sdk-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/globus-compute-sdk-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add globus-compute-sdk
# for installing globally
pixi global install globus-compute-sdk
```
...
It is possible to list all of the versions of `globus-compute-sdk` available on your platform:
...
```
pixi search globus-compute-sdk --channel conda-forge
```
